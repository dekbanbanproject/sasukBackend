              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <div class="card-body pt-0">
                    <p class="pt-1" >เชียงใหม่<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_chiangmais->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a>   
                    ...
                    <p class="pt-1">ลำพูน<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_lamphoons->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">ลำปาง<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_lampangs->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">แพร่<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_praes->chwpart)}}"><b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">น่าน<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_nans->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">พะเยา<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_payouas->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">เชียงราย<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_chaingrays->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
                      ...
                      <p class="pt-1">แม่ฮ่องสอน<a href="{{ url('backend/layout/dashboardperson_only/'.$hos_per_maehongsons->chwpart)}}"> <b style="color:red;font-size:20px;font-weight:bold ml-3"> &nbsp;&nbsp;Click  !! </b></a> 
                        <span class="float-right">
